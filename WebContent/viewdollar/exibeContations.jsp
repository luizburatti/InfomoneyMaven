...
pageEncoding="utf-8"%> <%@ page import="entity.Moeda"%> <%@ page
import="java.util.ArrayList"%> <% ArrayList<Moeda>
  lista = (ArrayList<Moeda
    >) request.getAttribute("listaTodas"); %>
    ...
    <html lang="pt-br">
      ...
      <body>
          ...
          <div class="row">
                      ...
                      <div class="direct-chat-messages" id="newMessage">
                        <div class="direct-chat-msg right">
                          ...
                          <div class="direct-chat-text">
                            ...
                            moedas entre com os seguintes dados sendo eles:
                          </div>
                          <div class="direct-chat-text">
                            Código da moeda, Data de início e Fim.
                          </div>
                          <div class="direct-chat-text">
            ...
            <div class="col-lg-1" style="left: 400px">
              <button
                ...
                value="USD"
                name="dolar"
                class="btn btn-default codecoin"
                id="BT"
                data-toggle="modal"
        ...
        <footer class="main-footer">
          <strong
            >Copyright © 2021
            <a href="https://github.com/GabrielRinaldin/inFomoney"> GitHub</a>.
          </strong>
          All rights reserved.
            ...
            $(".codecoin").click(function () {
              ...
              function drawCurveTypes(result) {
                ...
                var chart = new google.visualization.LineChart(
                  document.getElementById("drawCurveTypes")
                );
        ...
        <script type="text/javascript">
          $(document).ready(function () {
            ...
            var endPointURL =
              "ws://" + window.location.host + contextoWeb + "/chat";
            var chatClient = null;
