...
//	      moedas.setId(dadosMoedas.getInt("id"));
	      ...
	      moedas.setHigh(dadosMoedas.getString("high"));
	      moedas.setLow(dadosMoedas.getString("low"));
	      moedas.setVarBid(dadosMoedas.getString("varBid"));
	      moedas.setPctChange(dadosMoedas.getString("pctChange"));
	      moedas.setBid(dadosMoedas.getString("bid"));
	      moedas.setAsk(dadosMoedas.getString("ask"));
	      moedas.setTimestamp(dadosMoedas.getString("timestamp"));
