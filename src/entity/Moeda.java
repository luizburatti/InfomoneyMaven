...
public class Moeda {
	...
	public Moeda(int id, String code, String codein, String name, float high, float low, float varBid, float pctChange,
			float bid, float ask, long timestamp, String create_date) {
		super();
		this.id = id;
		this.code = code;
		this.codein = codein;
	...
	public Moeda(String code, String codein, String name, float high, float low, float varBid, float pctChange,
			float bid, float ask, long timestamp, String create_date) {
		super();
		this.code = code;
		this.codein = codein;
